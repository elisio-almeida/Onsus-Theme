                                ...
                                if ( class_exists( 'YITH_WCWL' ) ) { ?>
                                    <div class="header-wishlist-wrapper">
                                        <a class="nav-wishlist-trigger" href="<?php echo esc_url( htmlspecialchars( YITH_WCWL()->get_wishlist_url() ) ); ?>" >
                                            <?php echo themesflat_svg( 'wishlist_all' ); ?>
                                        ...
                                        <div class="content">
                                            <p><?php echo esc_html__('wishlist:', 'onsus') ?></p>
                                            <?php if ( yith_wcwl_count_all_products() ): ?>
                                                <span class="wishlist-count"><?php echo yith_wcwl_count_all_products(); ?></span>
                                            <?php else: ?>
                                    ...
                                    <div class="header-cart-wrapper">
                                        <div class="content-cart-item">
                                            ...
                                            <div class="inner-content">
                                                <p><?php echo esc_html__('Your cart:', 'onsus') ?></p>
                                                <div class="total-cart"><?php do_action( 'woocommerce_widget_shopping_cart_total' ); ?></div>
                                            </div>
                                        </div>
