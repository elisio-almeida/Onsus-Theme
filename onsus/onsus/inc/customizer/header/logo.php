...
$wp_customize->add_control(
    new WP_Customize_Image_Control(
        ...
        'site_logo_fixed',
        array(
           'label'          => esc_html__( 'Upload Your Logo Header Fixed', 'onsus' ),          
           'type'           => 'image',
           'section'        => 'section_logo',
           'priority'       => 1,
        )
...
$wp_customize->add_control(
    new WP_Customize_Image_Control(
        ...
        'site_logo_mobile',
        array(
           'label'          => esc_html__( 'Upload Your Logo On Mobile', 'onsus' ),
           'description'    => esc_html__( 'If you don\'t display logo please remove it your website display 
            Site Title default in General', 'onsus' ),
           'type'           => 'image',
           'section'        => 'section_logo',
